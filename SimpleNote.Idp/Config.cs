        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new ApiResource[]
            {
                new ApiResource("restapi", "My RESTful API", 
                        new List<string>{"name","gender",JwtClaimTypes.PreferredUserName})
            };
        }
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new[]
            {
                ...
                new Client
                {
                    ...
                    RequireConsent = false, //no need to click to agree
                    AccessTokenLifetime = 180, //seconds
