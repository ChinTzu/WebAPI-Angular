...
namespace SimpleNote.Api.Helpers
{
    ...
    public class SupportMediaType : Attribute, IActionConstraint
    {
        private readonly string _requestHeaderToMatch;
        private readonly MediaTypeCollection _mediaTypes = new MediaTypeCollection();

        public SupportMediaType(string requestHeaderToMatch,string mediaType, params string[] otherMediaTypes)
        {
